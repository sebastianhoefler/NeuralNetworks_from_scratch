...
'''
- Apply in between layers
- normalize with parameters that are learnable (gamma (weights), beta(bias))
'''
class BatchNormalization():
    """
    Note:
    The running mean and variance are calculated using exponential moving average with the 
    coefficient defined by 'alpha' attribute.
    """
